...
def ssl_call(method_name, params, endpoint, key_path='expedient-key.pem', cert_path='expedient-cert.pem', host='127.0.0.1', port=8001):
    creds_path = os.path.normpath(os.path.join(os.path.dirname(__file__), '..', 'keys/ssl'))
